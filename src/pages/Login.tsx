...
const Login: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>تسجيل الدخول | كنيسة الأنبا رويس بكفر فرج</title>
      ...
      <div className="min-h-screen flex justify-center items-center relative">
        ...
        >
          ...
          {showPopup && (
            <div
              className={`relative w-96 bg-transparent border-2 border-white/50 rounded-3xl backdrop-blur-3xl shadow-2xl flex justify-center items-center overflow-hidden transition-all duration-500 ease-in-out ${showPopup ? 'scale-100' : 'scale-0'
                } h-130`}
              style={{
