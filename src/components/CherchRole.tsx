...
const images = [
    { src: '/Images/card/1.jpg', label: 'Architecture Example 1' },
    { src: '/Images/card/2.jpg', label: 'Architecture Example 2' },
    { src: '/Images/card/3.jpg', label: 'Architecture Example 3' },
    { src: '/Images/card/4.jpg', label: 'Architecture Example 4' },
    { src: '/Images/card/5.jpg', label: 'Architecture Example 5' },
    { src: '/Images/card/11.jpg', label: 'Architecture Example 6' },
