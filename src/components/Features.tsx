...
export default function Features() {
  return (
    <div className="min-h-screen bg-amber-50 dark:bg-gray-800 py-4 px-2 sm:px-4 md:px-6 lg:px-8 flex flex-col items-center">
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center">
        {/* Responsive grid for features */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8 mb-6 justify-items-center">
          <div className="flex justify-center w-full">
            <Link to="/meetings" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
          ...
          <div className="flex justify-center w-full">
            <Link to="/trips" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
          ...
          <div className="flex justify-center w-full">
            <Link to="/read-bible" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8 mb-6 justify-items-center mt-6 sm:mt-12 lg:mt-20">
          <div className="flex justify-center w-full">
            <Link to="/confession" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
          ...
          <div className="flex justify-center w-full">
            <Link to="/events" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
          ...
          <div className="flex justify-center w-full">
            <Link to="/news" className="w-full max-w-[18rem] min-w-[16rem] sm:max-w-xs md:max-w-sm mx-auto">
              <Card3D
